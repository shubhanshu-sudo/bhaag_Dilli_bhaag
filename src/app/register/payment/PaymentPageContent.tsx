                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    {paymentStatus === 'success' && (
                        <div className="animate-in fade-in zoom-in-95 duration-700">
                            ...
                            <div className="bg-white rounded-2xl p-6 sm:p-8 border-2 border-green-100 shadow-lg mb-8 relative overflow-hidden group hover:border-green-300 transition-all duration-300">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-green-50 rounded-full -mr-16 -mt-16 opacity-40 group-hover:scale-110 transition-transform duration-500"></div>
                                <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                                    <div className="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 bg-green-500 rounded-2xl flex items-center justify-center shadow-xl shadow-green-200 animate-bounce-subtle">
                                        <svg className="w-10 h-10 sm:w-12 sm:h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.414 0 .018 5.393 0 12.03c0 2.123.544 4.197 1.583 6.03l-1.683 6.142 6.273-1.644a11.8 11.8 0 005.86 1.55h.005c6.635 0 12.03-5.393 12.03-12.03a11.785 11.785 0 00-3.528-8.528" />
                                        </svg>
                                    </div>
                                    <div className="flex-grow text-center md:text-left">
                                        <h3 className="text-xl sm:text-2xl font-black text-blue-900 mb-2">Join Our WhatsApp Group!</h3>
                                        <p className="text-gray-600 text-sm sm:text-base font-medium leading-relaxed">
                                            You can get more information & updates about the race day, BIB collection, and more by joining our community.
                                        </p>
                                    </div>
                                    <a
                                        href="https://chat.whatsapp.com/KqQB3E9AfCqETmEWQXlDyk?mode=gi_t"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-shrink-0 w-full md:w-auto bg-[#25D366] hover:bg-[#128C7E] text-white font-black px-8 py-4 rounded-2xl shadow-xl shadow-green-200 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3 group/link"
                                    >
                                        JOIN NOW
