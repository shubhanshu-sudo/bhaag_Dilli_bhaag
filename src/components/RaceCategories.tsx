                                ...
                                <div className="mt-auto">
                                    ...
                                    <div className="block">
                                        <button
                                            ...
                                            className="text-blue-700 font-bold hover:text-blue-900 flex items-center justify-center md:justify-start gap-2 transition-colors cursor-pointer group-hover:translate-x-1 duration-300 w-full md:w-auto"
                                        >
                                            Register Now
