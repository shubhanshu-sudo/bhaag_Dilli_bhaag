        ...
        <section className="bg-blue-50/50 py-24 relative">
            <div className="max-w-7xl mx-auto px-6 md:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-black text-blue-900 italic tracking-tight">
                        Race Categories
                    </h2>
                    ...
                    {categories.map((category, index) => (
                        <div key={index} className="flex flex-col group">
                            ...
                            <div className="mb-6 pb-6 border-b border-blue-200">
                                <h3 className="text-5xl font-black text-blue-700 mb-2 group-hover:text-blue-600 transition-colors">
                                    {category.distance}
                                </h3>
                                <h4 className="text-xl font-bold text-gray-900 uppercase tracking-wide text-yellow-600">
                                    {category.title}
                                </h4>
                            </div>
                            ...
                            <div className="mt-auto">
                                <p className="text-sm font-semibold text-blue-900 bg-blue-100/50 inline-block px-3 py-1 rounded-full mb-6">
                                    {category.age}
                                </p>
                                <div className="block">
                                    <Link href="/register">
                                        <span className="text-blue-700 font-bold hover:text-blue-900 flex items-center gap-2 transition-colors cursor-pointer group-hover:translate-x-1 duration-300">
                                            Register Now
